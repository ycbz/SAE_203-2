...
$requete='SELECT nom_maison, embleme, devise FROM maison';
...
<body class="sombre" style="margin-top: 0px;margin-left: 0px;margin-bottom: 0px;margin-right: 0px;">
    ...
    <div class="grille">
        ...
        <div class="droite1">
            ...
            <img id="maisons" src="Images/maisons.jpg">
            ...
            <ul class="liste">
                ...
                <?php
                    for ($i=0;$i<$nbproduits;$i++){
                        echo "</br><li>".$tabProduits[$i]["nom_maison"]."</br><b>Emblème</b> : ".$tabProduits[$i]["embleme"]."</br><b>Devise</b> : ".$tabProduits[$i]["devise"]."</li>";
                    }
                ?>
